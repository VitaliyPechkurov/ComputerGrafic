package Labs.PechkurovV.drawer;
...
/**
 * Візуалізація набору відрізків.
 * Відрізок заданий 2 точками.
 * Відображений кадр відповідає розміру екрана та охоплює ваше вікно перегляду.
 * Початок декартової системи координат знаходиться в центрі вашого огляду.
 *
 * Точка - відрізок з однаковими кінцями.
 * */
