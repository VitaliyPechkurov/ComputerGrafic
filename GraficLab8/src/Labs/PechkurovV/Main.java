...
public class Main {
    ...
    private static ArrayList<Point> build(ArrayList<Point> points){
    ...
    private static ArrayList<Point> halfBuild(ArrayList<Point> points, boolean flag){
        if(points.size()<3) return points;
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            for (Point point : p) System.out.println("(" + point.x + ", " + point.y + ")");
        }
    }
}