package Labs.PechkurovV;// the voronoi diagram (a set of edges) for a set of points (sites)

import Labs.PechkurovV.datastructures.Edge;
import Labs.PechkurovV.datastructures.Parabola;
import Labs.PechkurovV.datastructures.Point;
import Labs.PechkurovV.drawer.StdDraw;
import Labs.PechkurovV.datastructures.Event;
